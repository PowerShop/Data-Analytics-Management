    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navMenu">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'add_project.php') ? 'active' : ''; ?>"
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'main_projects.php') ? 'active' : ''; ?>"
                        href="main_projects.php">
                        <i class="fas fa-project-diagram me-1"></i> จัดการโครงการหลัก
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'manage_indicators.php') ? 'active' : ''; ?>"
                        href="manage_indicators.php">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'index.php') ? 'active' : ''; ?>"
                        href="/kittisak/routes/?redirect=dashboard" target="_blank">
            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="admin_find_replace.php"><i
                                    class="fas fa-search-plus me-2 text-warning"></i>Admin Find & Replace</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                        <li>
                            <h6 class="dropdown-header">ผู้ใช้: <?php echo $_SESSION['admin_username']; ?></h6>
                        </li>
                        <li>
