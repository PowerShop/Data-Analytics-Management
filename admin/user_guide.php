        ...
        <div class="container">
            ...
            <div class="content-section">
                ...
                <div class="toc">
                    <ul>
                        ...
                        <li><a href="#table-report">📋 หน้ารายงานโครงการ</a></li>
            ...
            <div class="content-section" id="dashboard">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="feature-card">
                            <div class="feature-title">📊 รายงานโครงการ</div>
            ...
            <div class="content-section" id="table-report">
                <h2 class="section-title">
                    <i class="fas fa-table"></i>หน้ารายงานโครงการ (<code>projects_table_view.php</code>)
                </h2>
